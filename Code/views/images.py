...
class Images(pygame.sprite.Sprite):
    ...
    def __init__(self, image, screen):
        ...
        self.unscaled_image = pygame.transform.smoothscale(self.unscaled_image,
                                                           (960, 1080))
...
class ImageFolder(pygame.sprite.Sprite):
    ...
    def __init__(self, tag, pos_list):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load('/home/lab/Desktop/Eder-Bachelor/Bachelor/Code/views/folder.png')
